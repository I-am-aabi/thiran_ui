...
import 'package:thiran_ui/view/home/widget/custom_text.dart';
import 'package:thiran_ui/view/home/widget/home_tile.dart';
import 'package:thiran_ui/view/home/widget/profile_dp.dart';
import 'package:thiran_ui/view/project_screen/widget/circular_indicaator.dart';
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(child: CircularIndicator(index: index)),//progress indicator
        ],
      ),
    );
  }
